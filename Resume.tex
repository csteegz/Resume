...
pdfkeywords={Java, Computer Engineering, Engineering, Electrical Engineering, UMD, Maryland, Leadership, Reverse Engineering, IDA Pro, Python, Cyber, Cyber Security, Security, Malware Analysis, Malware, Git, Development, Software Development, REST, Big Data, IDA, }
  }
\usepackage{multicol}
\usepackage{enumitem}
\usepackage{enumitem}
...
%% \\ \textbf{TS with Full Scope Polygraph}
\end{center}
}
